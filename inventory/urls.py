...
urlpatterns = [
    ...
    path('stock_order/history/', views.stock_order_history, name='stock_order_history'),
    path('stock_order/delete/<int:order_id>/', views.delete_stock_order, name='delete_stock_order'),
    # Authentication
